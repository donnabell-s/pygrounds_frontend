...
type TopicModalProps = {
    ...
    initialData?: AdminTopic;
    title: string;
    zones: AdminZone[];
};

const TopicModal = ({ isOpen, onClose, onSubmit, initialData, title, zones }: TopicModalProps) => {
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div>
                    ...
                    <select
                        id="zone"
                        value={formData.zone}
                        onChange={(e) => setFormData((prev) => ({ ...prev, zone: parseInt(e.target.value) }))}
                        className="mt-1 w-full rounded-md border border-gray-300 p-2"
                    >
